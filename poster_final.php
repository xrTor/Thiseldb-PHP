...
<div style="float: right; width: 220px; margin-left: 20px; text-align: right;">
  <img src="<?= htmlspecialchars($row['image_url']) ?>" alt="Poster" style="width: 100%; border-radius: 2px;">
  ...
  <p><strong>🌐 שפת מקור:</strong><br>
      ...
      if ($lang_result->num_rows > 0):
        while ($l = $lang_result->fetch_assoc()):
          ...
          echo "<a href='language.php?lang_code=" . urlencode($lang_code) . "' class='tag'>" . htmlspecialchars($lang_code) . "</a><br> ";
        endwhile;
      else:
